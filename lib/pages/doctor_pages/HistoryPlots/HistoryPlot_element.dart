...
class HistoryPlotElement extends StatefulWidget {
  ...
  const HistoryPlotElement({Key key, this.expandedTitle, this.data})
      : super(key: key);

  @override
  _HistoryPlotElementState createState() => _HistoryPlotElementState();
}

class _HistoryPlotElementState extends State<HistoryPlotElement> {
  List<dynamic> data = [];
  int xMax;
  bool m = false;
  double x;
  ...
  bool isRangeOn24HoursGraph = false;
                    ...
                    LineChart(
                      LineChartData(
                        ...
                        lineBarsData: [
                          ...
                          LineChartBarData(
                            spots:
                                generateSpots(dataToPlot_hr, dataIndex_to_show),
